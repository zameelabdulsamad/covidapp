...
class _RegisterVaccinationScreenState extends State<RegisterVaccinationScreen> {
                        ...
                        itemBuilder: (BuildContext context,
                          ...
                          return Padding(
                            ...
                            child: new DistrictCard(
                              ...
                              onTap: () {
                                changeDistrict(getDistrictList()[index]);
                              },
                            ),
                          );
                        })),
  ...
  void changeDistrict(String name) {
    ...
    setState(() {
      ...
      for (int i = 0; i < districtCodeList.length; i++) {
        if (districtCodeList[i].districtName == name) {
          selectedDistrictCode = districtCodeList[i].districtCode;
        }
      }
    });
  }
...
class StateCard extends StatelessWidget {
  ...
  const StateCard({Key key, this.state, this.onTap})
      : super(key: key);
